...
if folder_name == "euclidean" or folder_name == "fastRELIC": 
    feature_average[folder_name] = []

if folder_name == "mixed":
    feature_average["euclidean"] = []
    feature_average["fastRELIC"] = []

for folder in os.listdir(FOLDER_PATH):
    folder = FOLDER_PATH + folder + "/"
    mean_files = [f for f in os.listdir(folder) if 'Mean' in f]
    print(folder, mean_files)

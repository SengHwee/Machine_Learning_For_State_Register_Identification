...
def classification_model(x_train, hidden_layers, first_neuron, hidden_neurons, optimizer='adam', loss='binary_crossentropy'):
    ...
    for _ in range(hidden_layers):
        model.add(Dense(hidden_neurons, input_shape= (x_train.shape[1],), activation='relu'))
...
def run_data(kerasmodel, x_train, y_train, x_test, y_test, *,epochs=15, batch_size=25, r):
    keras_model=kerasmodel(x_train, hidden_layers=15, first_neuron=70, hidden_neurons=60, optimizer='adam', loss='binary_crossentropy')
